...
STEP_DEFAULTS = {
    ...
    "min_pairs_per_actor": 64,
    "min_unique_pairs_per_critic": None,
...
def main():
    ...
    result = society_alternating_train(
        ...
        max_critic_pair_duplicate_rate=getattr(args, "max_critic_pair_duplicate_rate", 0.0),
        ...
        min_style_confidence=getattr(args, "min_style_confidence", 0.65),
        allow_skip_low_data=getattr(args, "allow_skip_low_data", False),
        max_actor_fallback_ratio=getattr(args, "max_actor_fallback_ratio", 0.5),
